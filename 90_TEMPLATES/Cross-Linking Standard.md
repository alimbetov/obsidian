...
Advanced concept должен завершаться навигационным блоком. В template используй audit-safe placeholders, а перед публикацией замени их реальными wikilinks:
...
- **Production cases:** <PRODUCTION_CASES_WIKILINK>
- **Lab:** <LAB_WIKILINK>
- **Sources:** <SOURCES_WIKILINK>
- **Domain map:** <DOMAIN_MAP_WIKILINK>
```

Для supporting note достаточно:

```markdown
## Related materials

- **Canonical route:** <ROUTE_WIKILINK>
- **Parent concept:** <PARENT_CONCEPT_WIKILINK>
- **Practice:** <PRACTICE_WIKILINK>
```
...
- concept, который experiment доказывает;
...
Плохой вариант — три generic domain links без объяснения связи:

```text
See also: <GENERIC_JAVA_LINK>, <GENERIC_SPRING_LINK>, <GENERIC_DATABASE_LINK>
```
...
- Source index может быть intentional evidence leaf, но предпочтительно содержит backlink на parent route.
